...
class TweetNotificationsController extends ControllerBase<TweetNotificationsServiceBase> {
  TweetNotificationsController({@required service}) : super(service: service);

  Future<List<TweetNotificationModel>> getMyTweetsNotifications(String myUserId) async {
